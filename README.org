...
Here instead of writting into a file, we open a pipe with =popen=. This
allows you to direcly command GnuPlot during your code execution. Note
...
This is a class that allows you to define or overwrite globally some options
