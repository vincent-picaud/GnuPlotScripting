...
Build status: [[https://travis-ci.org/vincent-picaud/GnuPlotScript][file:https://travis-ci.org/vincent-picaud/GnuPlotScripting.svg?branch=master]]
...
** News
  ...
  - [2019-12-08 Sun 20:21] \\
    ...
    v0.0.2. I will wait to have some feedback to know if it works under
    Windows & MacOS.
  - [2019-12-08 Sun 11:21] \\
    This is the pre-release 0.0.1. I am going to wait a little bit before
    finalizing the final version. This library is simple and the API is
